...
class WithdrawalLanding extends StatefulWidget {
  final String email;
  final String phone;

  const WithdrawalLanding({Key? key, required this.email, required this.phone})
      : super(key: key);

  @override
  State<WithdrawalLanding> createState() => _WithdrawalLandingState();
}

class _WithdrawalLandingState extends State<WithdrawalLanding>
