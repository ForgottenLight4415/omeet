...
Future<void> videoCall(BuildContext context, Withdrawal claim) async {
...
Future<void> recordAudio(BuildContext context, Withdrawal claim) async {
...
Future<void> recordVideo(
    BuildContext context, Withdrawal claim, VideoRecorder videoRecorder) async {
  LocationData? locationData = await _getLocationData(context);
...
Future<void> captureImage(BuildContext context, Withdrawal claim) async {
